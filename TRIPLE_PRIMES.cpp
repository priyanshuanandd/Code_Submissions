...
{
    // Create a boolean array to mark prime numbers (initially all prime)
...
bool findGoldbachPair(int evenNumber)
{
    for (int i = 2; i * i <= 1e10; ++i)
    {
        ...
        if (is_prime[i] == 1 && is_prime[sqrt(evenNumber - (i * i))] == 1 && isPerfectSquare(evenNumber - i * i) && (evenNumber - (i * i)) != (i * i))
        {
            //  bug(i, evenNumber - (i * i));

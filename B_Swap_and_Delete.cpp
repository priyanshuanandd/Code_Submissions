...
int calc(string &s, string &s2, int rem1, int rem0, int cnt)
{
    if (rem1 == 0 and rem0 == 0)
    {
        return cnt;
    }
    string curr;
    ...
    forn(i, s2.size())
    {
        if (s[i] == s2[i])
        {
            if (s2[i] == '1' and rem1 > 0)
            {
                rem1--;
                continue;
            }
            else if (s2[i] == '0' and rem0 > 0)
            {
                rem0--;
                continue;
            }
    ...
    // bug(s, s2, curr, cnt);
    return calc(s, curr, rem1, rem0, cnt);
}
void solve()
{
    string s;
    ...
    for (auto i : s)
    {
        ...
        else if (i == '0' and cnt1 > 0)
        {
            cnt1--;
            s2.push_back('1');
        }
        else if (cnt0 == 0 or cnt1 == 0)
        {
            //  bug(rem1, rem0);
            if (rem1 > 0 or rem0 > 0)
            {
    ...
    // bug(calc(s, s2, rem1, rem0, 0));
    ans += calc(s, s2, rem1, rem0, 0);
    cout << ans << endl;
}

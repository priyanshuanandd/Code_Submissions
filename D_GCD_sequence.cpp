...
void solve()
{
    ...
    forn(i, v1.size() - 1)
    {
        if (__gcd(v1[i], v1[i + 1]) >= prev)
        {
            prev = __gcd(v1[i], v1[i + 1]);
        }
        else
        {
            flag = 0;
    ...
    forn(i, v2.size() - 1)
    {
        // b2.push_back(__gcd(v2[i], v2[i + 1]));
        if (__gcd(v2[i], v2[i + 1]) >= prev)
        {
            prev = __gcd(v2[i], v2[i + 1]);
        }
        else
        {
            flag = 0;
    ...
    forn(i, v3.size() - 1)
    {
        if (__gcd(v3[i], v3[i + 1]) >= prev)
        {
            prev = __gcd(v3[i], v3[i + 1]);
        }
        else
        {
            flag = 0;
    ...
    {
        // b2.push_back(__gcd(v2[i], v2[i + 1]));
        if (__gcd(v4[i], v4[i + 1]) >= prev)
        {
            prev = __gcd(v4[i], v4[i + 1]);
        }
        else
        {
            flag = 0;

...
bool f(int x, int y, int prev)
{
    ...
    if (prev == 2 or prev == 6 or prev == 3)
    {
        ...
        {
            ans |= f(x, y + 1, 5) | f(x, y - 1, 4);
        }
    }
    if (prev == 2 or prev == 4 or prev == 5)
    {
        if (curr <= 2)
        {
            // ans |= f(x - 1, y, 2);
        ...
        {
            ans |= f(x, y + 1, 6) | f(x, y - 1, 3);
        }
    }
    if (prev == 1 or prev == 3 or prev == 4)
    {
        if (curr <= 2)
        {
            ans |= f(x, y + 1, 1);
        ...
        {
            ans |= f(x - 1, y, 5) | f(x + 1, y, 6);
        }
    }
    if (prev == 1 or prev == 5 or prev == 6)
    {
        if (curr <= 2)
        {
            ans |= f(x, y - 1, 1);
